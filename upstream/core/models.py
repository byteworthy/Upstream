...
class DomainAuditEvent(models.Model):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='domain_audit_events', null=True, blank=True)
...
class ProductConfig(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='product_configs')
