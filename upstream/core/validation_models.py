...
class ValidationRule(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE,
...
class ValidationResult(BaseModel):
    ...
    upload = models.ForeignKey('upstream.Upload', on_delete=models.CASCADE,
                              related_name='validation_results', null=True, blank=True)
    claim_record = models.ForeignKey('upstream.ClaimRecord', on_delete=models.CASCADE,
                                    related_name='validation_results', null=True, blank=True)
