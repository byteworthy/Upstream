...
from upstream.services.evidence_payload import build_denialscope_evidence_payload, get_alert_interpretation
...
class DenialScopeDashboardView(LoginRequiredMixin, ProductEnabledMixin, View):
    ...
    template_name = 'upstream/products/denialscope_dashboard.html'
