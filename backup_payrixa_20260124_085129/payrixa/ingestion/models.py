...
class IngestionRecord(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='ingestion_records')
...
class SystemEvent(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='system_events')
    ...
    related_drift_event = models.ForeignKey('upstream.DriftEvent', on_delete=models.SET_NULL,
                                           null=True, blank=True, related_name='system_events')
    related_alert = models.ForeignKey('upstream.AlertEvent', on_delete=models.SET_NULL,
                                     null=True, blank=True, related_name='system_events')
...
class IngestionToken(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='ingestion_tokens')
