...
class AlertRule(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='alert_rules')
...
class NotificationChannel(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='notification_channels')
    name = models.CharField(max_length=100)
...
class AlertEvent(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='alert_events')
    alert_rule = models.ForeignKey(AlertRule, on_delete=models.CASCADE, related_name='events')
    drift_event = models.ForeignKey('upstream.DriftEvent', on_delete=models.CASCADE, related_name='alert_events', null=True, blank=True)
    payment_delay_signal = models.ForeignKey('upstream.PaymentDelaySignal', on_delete=models.CASCADE, related_name='alert_events', null=True, blank=True)
    report_run = models.ForeignKey('upstream.ReportRun', on_delete=models.CASCADE, related_name='alert_events', null=True, blank=True)
...
class OperatorJudgment(BaseModel):
    ...
    customer = models.ForeignKey('upstream.Customer', on_delete=models.CASCADE, related_name='operator_judgments')
