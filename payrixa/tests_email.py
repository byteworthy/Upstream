...
class EmailSmokeTest(TestCase):
    ...
    def test_send_simple_email(self):
        ...
        email = EmailMessage(
            ...
            from_email="test@payrixa.com",
            to=["recipient@payrixa.com"],
        )
        email.send()
        ...
        self.assertEqual(mail.outbox[0].from_email, "test@payrixa.com")
        self.assertEqual(mail.outbox[0].to, ["recipient@payrixa.com"])
